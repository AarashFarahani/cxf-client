 ...
 * 
 */
@WebServiceClient(name = "GreetingServiceImplService", targetNamespace = "http://service.example.com/", wsdlLocation = "http://localhost:8080/services/GreetingService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName GREETINGSERVICEIMPLSERVICE_QNAME = new QName("http://service.example.com/", "GreetingServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/services/GreetingService?wsdl");
    ...
    public GreetingService getGreetingServiceImplPort() {
        return super.getPort(new QName("http://service.example.com/", "GreetingServiceImplPort"), GreetingService.class);
    }
    ...
    public GreetingService getGreetingServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.example.com/", "GreetingServiceImplPort"), GreetingService.class, features);
    }
